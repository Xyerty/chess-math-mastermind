...
import {
  ...
  Hourglass, Medal, MoveHorizontal, Package, Play, Podium, Rabbit, Rocket,
  Shield, ShieldAlert, ShieldCheck, Sigma, Skull, Sparkles, Star, Swords,
...
const iconMap: { [key: string]: React.FC<LucideProps> } = {
  ...
  Zap, BrainCircuit, Rabbit, BookOpen, GraduationCap, Bot,
